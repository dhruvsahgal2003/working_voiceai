...
export default function Login() {
  ...
  // Handle Google OAuth callback: /login?token=xxx or /auth/callback?token=xxx
  useEffect(() => {
    ...
    if (token) {
      ...
      // We have the token directly — store it and fetch user
  ...
  const googleAvailable = !!(window.__GOOGLE_CLIENT_ID__ || true); // show button, backend guards it
    ...
    <div className="auth-shell">
      <div className="auth-card">
        ...
        <a href="/api/auth/google"
          ...
          style={{ width: '100%', justifyContent: 'center', marginBottom: 16, gap: 10 }}
        >
